...
@section('content')
    <div class="container-fluid">
        <h5>Tilang Kendaraan</h5>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Cari Data Kendaraan</h6>
            </div>
            <div class="card-body">
                <form action="/tilang/search" method="get" class="d-none d-sm-inline-block form-inline my-2 my-md-0 w-100 navbar-search">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                <a href="/tilang/tambah?no-uji={{$result->nouji}}" class="btn btn-success">Daftarkan</a>
                            </div>
                        </div>
                    </div>
                </div>
